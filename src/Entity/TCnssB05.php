...
use App\Repository\TCnssB05Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: TCnssB05Repository::class)]
class TCnssB05
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\Column(length: 176, nullable: true)]
    private ?string $filler = null;

    #[ORM\ManyToOne(inversedBy: 'tCnssB05s')]
