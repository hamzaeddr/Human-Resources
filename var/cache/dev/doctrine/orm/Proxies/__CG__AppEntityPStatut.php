...
class PStatut extends \App\Entity\PStatut implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\PStatut' . "\0" . 'id', '' . "\0" . 'App\\Entity\\PStatut' . "\0" . 'designation', '' . "\0" . 'App\\Entity\\PStatut' . "\0" . 'icon'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIcon(?string $icon): \App\Entity\PStatut
    {
