 ...
 */
class getLcontractFonctionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LcontractFonctionRepository' shared autowired service.
     *
     * @return \App\Repository\LcontractFonctionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LcontractFonctionRepository.php';

        return $container->privates['App\\Repository\\LcontractFonctionRepository'] = new \App\Repository\LcontractFonctionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
