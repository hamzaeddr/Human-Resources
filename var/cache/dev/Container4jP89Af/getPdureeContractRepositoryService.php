 ...
 */
class getPdureeContractRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PdureeContractRepository' shared autowired service.
     *
     * @return \App\Repository\PdureeContractRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PdureeContractRepository.php';

        return $container->privates['App\\Repository\\PdureeContractRepository'] = new \App\Repository\PdureeContractRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
