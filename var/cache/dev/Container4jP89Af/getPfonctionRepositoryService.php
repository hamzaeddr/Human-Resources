 ...
 */
class getPfonctionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PfonctionRepository' shared autowired service.
     *
     * @return \App\Repository\PfonctionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PfonctionRepository.php';

        return $container->privates['App\\Repository\\PfonctionRepository'] = new \App\Repository\PfonctionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
