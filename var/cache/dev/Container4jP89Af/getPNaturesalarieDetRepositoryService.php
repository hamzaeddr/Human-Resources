 ...
 */
class getPNaturesalarieDetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PNaturesalarieDetRepository' shared autowired service.
     *
     * @return \App\Repository\PNaturesalarieDetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PNaturesalarieDetRepository.php';

        return $container->privates['App\\Repository\\PNaturesalarieDetRepository'] = new \App\Repository\PNaturesalarieDetRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
