 ...
 */
class getPPrelevementLgRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PPrelevementLgRepository' shared autowired service.
     *
     * @return \App\Repository\PPrelevementLgRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PPrelevementLgRepository.php';

        return $container->privates['App\\Repository\\PPrelevementLgRepository'] = new \App\Repository\PPrelevementLgRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
