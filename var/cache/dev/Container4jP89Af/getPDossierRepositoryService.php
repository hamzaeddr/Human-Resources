 ...
 */
class getPDossierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PDossierRepository' shared autowired service.
     *
     * @return \App\Repository\PDossierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PDossierRepository.php';

        return $container->privates['App\\Repository\\PDossierRepository'] = new \App\Repository\PDossierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
