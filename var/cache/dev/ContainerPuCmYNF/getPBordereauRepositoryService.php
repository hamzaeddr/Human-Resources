 ...
 */
class getPBordereauRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PBordereauRepository' shared autowired service.
     *
     * @return \App\Repository\PBordereauRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PBordereauRepository.php';

        return $container->privates['App\\Repository\\PBordereauRepository'] = new \App\Repository\PBordereauRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
