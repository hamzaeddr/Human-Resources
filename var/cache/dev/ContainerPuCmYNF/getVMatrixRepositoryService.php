 ...
 */
class getVMatrixRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VMatrixRepository' shared autowired service.
     *
     * @return \App\Repository\VMatrixRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VMatrixRepository.php';

        return $container->privates['App\\Repository\\VMatrixRepository'] = new \App\Repository\VMatrixRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
