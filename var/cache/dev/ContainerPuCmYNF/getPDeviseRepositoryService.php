 ...
 */
class getPDeviseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PDeviseRepository' shared autowired service.
     *
     * @return \App\Repository\PDeviseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PDeviseRepository.php';

        return $container->privates['App\\Repository\\PDeviseRepository'] = new \App\Repository\PDeviseRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
