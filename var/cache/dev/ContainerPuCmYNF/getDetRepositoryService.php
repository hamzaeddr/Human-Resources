 ...
 */
class getDetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetRepository' shared autowired service.
     *
     * @return \App\Repository\DetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetRepository.php';

        return $container->privates['App\\Repository\\DetRepository'] = new \App\Repository\DetRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
