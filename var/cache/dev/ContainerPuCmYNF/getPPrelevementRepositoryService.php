 ...
 */
class getPPrelevementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PPrelevementRepository' shared autowired service.
     *
     * @return \App\Repository\PPrelevementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PPrelevementRepository.php';

        return $container->privates['App\\Repository\\PPrelevementRepository'] = new \App\Repository\PPrelevementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
