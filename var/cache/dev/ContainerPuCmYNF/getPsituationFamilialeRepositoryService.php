 ...
 */
class getPsituationFamilialeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PsituationFamilialeRepository' shared autowired service.
     *
     * @return \App\Repository\PsituationFamilialeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PsituationFamilialeRepository.php';

        return $container->privates['App\\Repository\\PsituationFamilialeRepository'] = new \App\Repository\PsituationFamilialeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
