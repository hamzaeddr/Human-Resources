 ...
 */
class getUserOperationDossierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserOperationDossierRepository' shared autowired service.
     *
     * @return \App\Repository\UserOperationDossierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserOperationDossierRepository.php';

        return $container->privates['App\\Repository\\UserOperationDossierRepository'] = new \App\Repository\UserOperationDossierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
