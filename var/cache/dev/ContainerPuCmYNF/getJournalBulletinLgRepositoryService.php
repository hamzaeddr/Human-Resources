 ...
 */
class getJournalBulletinLgRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\JournalBulletinLgRepository' shared autowired service.
     *
     * @return \App\Repository\JournalBulletinLgRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'JournalBulletinLgRepository.php';

        return $container->privates['App\\Repository\\JournalBulletinLgRepository'] = new \App\Repository\JournalBulletinLgRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
