 ...
 */
class getTbulletinRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TbulletinRepository' shared autowired service.
     *
     * @return \App\Repository\TbulletinRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbulletinRepository.php';

        return $container->privates['App\\Repository\\TbulletinRepository'] = new \App\Repository\TbulletinRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
