 ...
 */
class getCabRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CabRepository' shared autowired service.
     *
     * @return \App\Repository\CabRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CabRepository.php';

        return $container->privates['App\\Repository\\CabRepository'] = new \App\Repository\CabRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
