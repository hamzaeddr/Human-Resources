 ...
 */
class getPArretTravailLgRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PArretTravailLgRepository' shared autowired service.
     *
     * @return \App\Repository\PArretTravailLgRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PArretTravailLgRepository.php';

        return $container->privates['App\\Repository\\PArretTravailLgRepository'] = new \App\Repository\PArretTravailLgRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
