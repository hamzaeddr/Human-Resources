 ...
 */
class getPCounterRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PCounterRepository' shared autowired service.
     *
     * @return \App\Repository\PCounterRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PCounterRepository.php';

        return $container->privates['App\\Repository\\PCounterRepository'] = new \App\Repository\PCounterRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
