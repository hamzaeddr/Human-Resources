 ...
 */
class getNaturePieceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NaturePieceRepository' shared autowired service.
     *
     * @return \App\Repository\NaturePieceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NaturePieceRepository.php';

        return $container->privates['App\\Repository\\NaturePieceRepository'] = new \App\Repository\NaturePieceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
