 ...
 */
class getProblemeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProblemeRepository' shared autowired service.
     *
     * @return \App\Repository\ProblemeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProblemeRepository.php';

        return $container->privates['App\\Repository\\ProblemeRepository'] = new \App\Repository\ProblemeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
