 ...
 */
class getJournalPaieDossierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\JournalPaieDossierRepository' shared autowired service.
     *
     * @return \App\Repository\JournalPaieDossierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'JournalPaieDossierRepository.php';

        return $container->privates['App\\Repository\\JournalPaieDossierRepository'] = new \App\Repository\JournalPaieDossierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), ($container->privates['App\\Repository\\PCompteComptableRepository'] ?? $container->load('getPCompteComptableRepositoryService')));
    }
}
