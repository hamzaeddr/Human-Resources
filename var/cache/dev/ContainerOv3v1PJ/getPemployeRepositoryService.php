 ...
 */
class getPemployeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PemployeRepository' shared autowired service.
     *
     * @return \App\Repository\PemployeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PemployeRepository.php';

        return $container->privates['App\\Repository\\PemployeRepository'] = new \App\Repository\PemployeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
