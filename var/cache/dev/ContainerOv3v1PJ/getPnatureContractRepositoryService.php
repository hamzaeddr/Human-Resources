 ...
 */
class getPnatureContractRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PnatureContractRepository' shared autowired service.
     *
     * @return \App\Repository\PnatureContractRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PnatureContractRepository.php';

        return $container->privates['App\\Repository\\PnatureContractRepository'] = new \App\Repository\PnatureContractRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
