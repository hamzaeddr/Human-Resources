 ...
 */
class getLElementEcheanceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LElementEcheanceRepository' shared autowired service.
     *
     * @return \App\Repository\LElementEcheanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LElementEcheanceRepository.php';

        return $container->privates['App\\Repository\\LElementEcheanceRepository'] = new \App\Repository\LElementEcheanceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
