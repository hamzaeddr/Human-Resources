 ...
 */
class getPrubriqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PrubriqueRepository' shared autowired service.
     *
     * @return \App\Repository\PrubriqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PrubriqueRepository.php';

        return $container->privates['App\\Repository\\PrubriqueRepository'] = new \App\Repository\PrubriqueRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
