 ...
 */
class getTbulletinLgRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TbulletinLgRepository' shared autowired service.
     *
     * @return \App\Repository\TbulletinLgRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbulletinLgRepository.php';

        return $container->privates['App\\Repository\\TbulletinLgRepository'] = new \App\Repository\TbulletinLgRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
