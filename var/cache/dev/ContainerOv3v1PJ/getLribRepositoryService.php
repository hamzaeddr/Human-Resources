 ...
 */
class getLribRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LribRepository' shared autowired service.
     *
     * @return \App\Repository\LribRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LribRepository.php';

        return $container->privates['App\\Repository\\LribRepository'] = new \App\Repository\LribRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
