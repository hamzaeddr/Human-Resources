 ...
 */
class getTCnssB00RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TCnssB00Repository' shared autowired service.
     *
     * @return \App\Repository\TCnssB00Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TCnssB00Repository.php';

        return $container->privates['App\\Repository\\TCnssB00Repository'] = new \App\Repository\TCnssB00Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
