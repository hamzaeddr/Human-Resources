 ...
 */
class getPBaremeCimtRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PBaremeCimtRepository' shared autowired service.
     *
     * @return \App\Repository\PBaremeCimtRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PBaremeCimtRepository.php';

        return $container->privates['App\\Repository\\PBaremeCimtRepository'] = new \App\Repository\PBaremeCimtRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
