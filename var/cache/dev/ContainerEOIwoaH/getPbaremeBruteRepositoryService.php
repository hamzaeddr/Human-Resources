 ...
 */
class getPbaremeBruteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PbaremeBruteRepository' shared autowired service.
     *
     * @return \App\Repository\PbaremeBruteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PbaremeBruteRepository.php';

        return $container->privates['App\\Repository\\PbaremeBruteRepository'] = new \App\Repository\PbaremeBruteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
