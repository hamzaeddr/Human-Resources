 ...
 */
class getPArretTravailRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PArretTravailRepository' shared autowired service.
     *
     * @return \App\Repository\PArretTravailRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PArretTravailRepository.php';

        return $container->privates['App\\Repository\\PArretTravailRepository'] = new \App\Repository\PArretTravailRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
