 ...
 */
class getLContractRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LContractRepository' shared autowired service.
     *
     * @return \App\Repository\LContractRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LContractRepository.php';

        return $container->privates['App\\Repository\\LContractRepository'] = new \App\Repository\LContractRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
