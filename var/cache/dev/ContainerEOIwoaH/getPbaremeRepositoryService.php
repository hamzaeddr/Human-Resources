 ...
 */
class getPbaremeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PbaremeRepository' shared autowired service.
     *
     * @return \App\Repository\PbaremeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PbaremeRepository.php';

        return $container->privates['App\\Repository\\PbaremeRepository'] = new \App\Repository\PbaremeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
