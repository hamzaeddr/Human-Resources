 ...
 */
class getTCnssB04RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TCnssB04Repository' shared autowired service.
     *
     * @return \App\Repository\TCnssB04Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TCnssB04Repository.php';

        return $container->privates['App\\Repository\\TCnssB04Repository'] = new \App\Repository\TCnssB04Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
