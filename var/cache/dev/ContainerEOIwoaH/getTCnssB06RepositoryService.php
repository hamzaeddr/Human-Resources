 ...
 */
class getTCnssB06RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TCnssB06Repository' shared autowired service.
     *
     * @return \App\Repository\TCnssB06Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TCnssB06Repository.php';

        return $container->privates['App\\Repository\\TCnssB06Repository'] = new \App\Repository\TCnssB06Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
