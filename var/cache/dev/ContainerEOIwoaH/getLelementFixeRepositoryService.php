 ...
 */
class getLelementFixeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LelementFixeRepository' shared autowired service.
     *
     * @return \App\Repository\LelementFixeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LelementFixeRepository.php';

        return $container->privates['App\\Repository\\LelementFixeRepository'] = new \App\Repository\LelementFixeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
