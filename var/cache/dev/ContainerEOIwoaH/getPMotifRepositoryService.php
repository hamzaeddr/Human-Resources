 ...
 */
class getPMotifRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PMotifRepository' shared autowired service.
     *
     * @return \App\Repository\PMotifRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PMotifRepository.php';

        return $container->privates['App\\Repository\\PMotifRepository'] = new \App\Repository\PMotifRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
