 ...
 */
class getPNaturesalarieCabRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PNaturesalarieCabRepository' shared autowired service.
     *
     * @return \App\Repository\PNaturesalarieCabRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PNaturesalarieCabRepository.php';

        return $container->privates['App\\Repository\\PNaturesalarieCabRepository'] = new \App\Repository\PNaturesalarieCabRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
