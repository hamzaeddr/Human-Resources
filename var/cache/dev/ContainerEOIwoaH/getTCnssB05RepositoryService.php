 ...
 */
class getTCnssB05RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TCnssB05Repository' shared autowired service.
     *
     * @return \App\Repository\TCnssB05Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TCnssB05Repository.php';

        return $container->privates['App\\Repository\\TCnssB05Repository'] = new \App\Repository\TCnssB05Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
